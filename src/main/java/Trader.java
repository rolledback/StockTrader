...
public class Trader {
    ...
    public Trader(String id, double startingMoney) {
        this.id = id;
    ...
    public void addStock(String stockId, int quantity, double value) {
    ...
    public void removeStock(String stockId, int quantity, double value) {
